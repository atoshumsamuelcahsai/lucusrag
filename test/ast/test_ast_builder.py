...
"""
    ...
    @patch("rag.schemas.code_element.CodeElement.generate_explanation")
    def test_generates_explanations_when_requested(
        self, mock_generate, tmp_path, temp_python_file, mock_state, mock_parser
    ):
        """Test that explanations are generated when flag is True."""
        results_dir = tmp_path / "results"
        results_dir.mkdir()
        progress_file = tmp_path / "progress.json"
        ...
        # Should have called generate_explanation
...
"""
    ...
    def test_generates_explanations_when_requested(self, temp_project, tmp_path):
        ...
        with patch("rag.schemas.code_element.CodeElement.generate_explanation"):
            analyze_and_store_python_files(
                root_dir=str(temp_project),
                output_path=str(output_dir),
                parser_type="ast",
